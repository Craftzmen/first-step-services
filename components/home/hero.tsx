        ...
        <div className="grid items-center gap-14 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              <Link
                href="/contact"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-full border border-amber/20 bg-amber px-7 text-base font-semibold text-white hover:bg-amber-light"
              >
          ...
          <div className="relative lg:col-span-5">
            <div className="relative">
              ...
              <div className="absolute -left-4 top-12 hidden rounded-2xl border border-white/15 bg-navy-light px-4 py-3 sm:block md:-left-8">
              ...
              <div className="absolute -right-4 bottom-10 hidden rounded-2xl border border-white/15 bg-navy-light px-4 py-3 sm:block md:-right-8">
                <div className="flex items-center gap-3">
                  <div className="flex size-9 items-center justify-center rounded-xl bg-amber/20 text-amber">
